% This pulse lets you specify a mV step and the amount of averages you
% require. It increments Linearly
classdef LEDStepPulse < PetriProtocol
    
    
    properties (Constant)
        identifier = 'petri.symphony-das.LEDStepPulse'
        version = 1
        displayName = 'LED Step Pulse'
    end
...
%             obj.setDeviceBackground([obj.StimulusLED 'AORB'], ttl, '_unitless_');
        ...
        function isOverMaxAmplitude(obj)
            ...
            maxEquationValue = obj.initialPulseAmplitude + ( obj.pulseSteps * (obj.numberOfAverages-1) );
