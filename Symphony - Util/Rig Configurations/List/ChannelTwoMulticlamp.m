classdef ChannelTwoMulticlamp < PetriRigConfiguration
    
    properties (Constant)
        displayName = 'Channel 2 Multiclamp'
    end
...
%             obj.addDevice('Ch3', 'ANALOG_OUT.0', '');   % If adding a 3rd LED Channel, this line needs to be uncommented & vice versa
