...
classdef Axopatch < PetriRigConfiguration
    ...
    methods         
        ...
        function createDevices(obj)
            % addAxoPatchDevice(obj, deviceName, externalCommandInputFrontPanel, gain, frequency, mode, cellCapacitence, scaledOutput, tenVmOutput)
            % addAxoPatchDevice(deviceName, externalCommandInputFrontPanel, gain, frequency, mode, cellCapacitence, scaledOutput, tenVmOutput)
            %obj.addAxoPatchDevice('Amplifier_Ch1', 'ANALOG_OUT.0', 'ANALOG_IN.0', 'ANALOG_IN.1', 'ANALOG_IN.2',  'ANALOG_IN.3', '' ,'');
          
          % obj.addAxoPatchDevice('Amplifier_Ch1', '', 'ANALOG_IN.0', 'ANALOG_IN.1', 'ANALOG_IN.2',  'ANALOG_IN.3', '' ,'ANALOG_IN.4');
           obj.addAxoPatchDevice('Amplifier_Ch1', 'ANALOG_OUT.1', 'ANALOG_IN.0', 'ANALOG_IN.1', 'ANALOG_IN.2',  '', 'ANALOG_IN.4' ,'');
          % obj.addAxoPatchDevice('Amplifier_Ch1', '', 'ANALOG_IN.0', 'ANALOG_IN.1', 'ANALOG_IN.2',  '', 'ANALOG_IN.4' ,'');
...
%           obj.addDevice('Ch3AORB', 'DIGITAL_OUT.1', '');   % output only
            ...
            obj.addDevice('ShutterTrigger', 'DIGITAL_OUT.1', '');
